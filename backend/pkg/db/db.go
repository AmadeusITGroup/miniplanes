...
// Adapter sets interface for http.Handler
type Adapter func(http.Handler) http.Handler

func binder(f func(w http.ResponseWriter, r *http.Request), db *mgo.Session) func(w http.ResponseWriter, r *http.Request) {
...
// Adapt installs all the adapters
...
func handle(w http.ResponseWriter, r *http.Request) {
	...
	case "GET":
		switch r.RequestURI {
		case "/airlines":
			handleReadAirlines(w, r)
		case "/routes":
			handleReadRoutes(w, r)
		case "/airports":
			handleReadAirports(w, r)
		}
	case "POST":
		handleInsert(w, r)
	default:
